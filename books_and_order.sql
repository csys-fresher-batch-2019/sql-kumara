...
values(1,'RDBMS','Rudran',150,'stalin',1,'Computer Science',1);

insert into books(book_id,book_name,author_name,price,publisher,version,categories,active)
values(2,'Code Complete','Steve',300,'Aravind',2,'Computer Science',1);


insert into books(book_id,book_name,author_name,price,publisher,version,categories,active)
values(3,'Vedha','nalu',100,'story teller',1,'Story',1);
...
values(order_id_seq.nextval,'Vikram',1,sysdate,300,2,'Pending');
...
insert into orders(order_id,username, book_id,ordered_date,total_amount,Quantity,status)
values(order_id_seq.nextval,'Jey',3,sysdate,1000,10,'Delivered');


insert into orders(order_id,username, book_id,ordered_date,total_amount,Quantity)
values(order_id_seq.nextval,'Jey ram',2,sysdate,600,4);
...
select book_name,(select quantity from book_stock where book_id = b.book_id) as qty from books b;
